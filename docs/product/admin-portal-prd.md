...
- **$0 constraint.** No new paid hosting, database, storage, or API. Stack stays Vercel Hobby + Aiven Free Postgres + Umami Cloud Free. Any feature that would cross a free tier must degrade gracefully and be flagged against the roadmap's [Scaling Milestones](master-roadmap.md).
